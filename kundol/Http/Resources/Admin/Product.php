    ...
    public function toArray($request)
    {
        ...
        if (\Request::route()->getName() == 'products.index' ) {
            return [
                ...
                'product_price_symbol' => !isset($currency->symbol_position) ? $this->price * $this->exchange_rate : ($currency->symbol_position == 'right' ? ($this->price * $this->exchange_rate).' '.$currency->code : $currency->code.' '.(number_format($this->price * $this->exchange_rate,2))),
                'currency' => $currency,
                'product_discount_price' => $this->discount_price * $this->exchange_rate,
                'product_discount_price_symbol' => !isset($currency->symbol_position) ? $this->discount_price * $this->exchange_rate : ($currency->symbol_position == 'right' ? ($this->discount_price * $this->exchange_rate).' '.$currency->code : $currency->code.' '.(number_format($this->discount_price * $this->exchange_rate,2))),
