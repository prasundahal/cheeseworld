              ...
              <div class="slick-w4">
                  <div class="items d-flex align-items-center">
                      <div class="image mr-4 w-50 mb-xl-0 mb-md-3 mb-3">
                          <img src="{{ asset('frontend/image/banner/1.jpg') }}" class="img-fluid">
                      </div>
                      <div class="content w-50">
                          <div class="head ">
                              <h3 class="font-weight-bold">Who we are</h3>
                          </div>
                          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi minima
                              molestiae ad
                              tenetur eum accusamus, quos vero possimus impedit hic ipsum harum natus sint quas
                              veniam doloribus consectetur cupiditate optio! Adipisicing elit. Quasi minima
                              molestiae ad
              ...
              <div class="col-xl-6 col-lg-6 col-12 mt-xl-2 mt-md-3 mt-4">
                  <div class="number d-flex flex-column justify-content-center h-100">
                      ...
                      <div class="row num-1">
                          ...
                          <div
                              class="col-xl-4 col-lg-4 col-6 col-12 d-flex align-items-center justify-content-end">
      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-xl-4 col-lg-4 col-md-6 col-12 mb-xl-2 mb-md-2 mb-3">
                  <div class="card">
                      <div class="card-head">
                          <img class="card-img-top" src="{{ asset('frontend/image/who-we-are/1') }}0.jpg" alt="Card image cap">
                          <h5 class="card-title text-white font-weight-bold text-center w-100">Artsana Group</h5>
                      </div>
                      <div class="card-body">

                          <p class="card-text">We meet current needs, by hearing and heeding your comments, and we
              ...
              <div class="col-xl-4 col-lg-4 col-md-6 col-12 mb-xl-2 mb-md-2 mb-3">
                  <div class="card">
                      <div class="card-head">
                          <img class="card-img-top" src="{{ asset('frontend/image/who-we-are/1') }}1.jpg" alt="Card image cap">
