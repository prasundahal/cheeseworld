...
<body>
                ...
                <div class="main-header row py-2">
                    ...
                    <div class="col-4 m-auto">
                        <div class="logo text-center">
                            <img src="{{ asset('frontend/image/logo/logo.png') }}" alt="nav" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-4 m-auto">
                        <div class="notice">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav m-auto">
                            <li class="nav-item dropdown px-3">
                                <a class="nav-link dropdown-toggle font-weight-bold d-block" href="#"
    ...
    <section id="research-center-wrapper">
        ...
        <section id="banner-wrapper" class="py-3">
            <div class="image">
                <img src="{{ asset('frontend/image/research-center/1.jpg') }}" alt="banner-image" class="img-fluid">
            </div>
        </section>
        <!-- Banner Section Ends -->
            ...
            <div class="container">
                ...
                <div class="row py-5">
                    <div class="col-6">
                        <div class="content">
                            <p>
                                Like all good things in this world, being a parent requires a lot of effort
                                and
                                sometimes it
        ...
        <section id="cards" class="py-5 bg-light">
            <div class="container">
                <div class="row">
                    <div class="col-4 mb-5">
                        <div class="card">
                            <div class="card-head">
                                <img class="card-img-top" src="{{ asset('frontend/image/who-we-are/9.jpg') }}" alt="Card image cap">
                                <h5 class="card-title text-white font-weight-bold text-center w-100 px-4">Explaining the
                                    coronavirus to children</h5>
                            </div>
                            <div class="card-body">
                                ...
                                <p class="card-text mb-4">Some quick example text to build on the card title and make up
                                    ...
                                    card's
                                    content.</p>
                                <a href="#" class="text-uppercase font-weight-bold">Read all</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-4 mb-5">
                        <div class="card">
                            <div class="card-head">
                                <img class="card-img-top" src="{{ asset('frontend/image/who-we-are/11.jpg') }}" alt="Card image cap">
                                <h5 class="card-title text-white font-weight-bold text-center w-100 px-4">Things you can
                                    do
                                </h5>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-4 mb-5">
                        <div class="card">
                            <div class="card-head">
                                <img class="card-img-top" src="{{ asset('frontend/image/who-we-are/9.jpg') }}" alt="Card image cap">
                                <h5 class="card-title text-white font-weight-bold text-center w-100 px-4">Sterilisation:
                                    an
                                    act of protection</h5>
                            </div>
                            <div class="card-body">
                ...
                <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <ul class="info p-0 ml-0">
                                <li>
                                    <span class="mr-2"><i class="fa fa-phone" aria-hidden="true"></i></span> 1800
                                    102
                                    6702
                                </li>
                                <li>
